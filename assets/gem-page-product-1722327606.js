    ...
    (function( jQuery ){
  var $module = jQuery('#m-1729539297219').children('.module');
  $module.gfV3Product();
    ...
    (function( jQuery ){
  // var $module = jQuery('#m-1729539297207').children('.module');
  // You can add custom Javascript code right here.
})( window.GemQuery || jQuery );
  
    (function(jQuery) {
    var $module = jQuery('#m-1729539297283').children('.module');
    ...
    (function( jQuery ){
  // var $module = jQuery('#m-1729539297285').children('.module');
  // You can add custom Javascript code right here.
})( window.GemQuery || jQuery );
  
    (function(jQuery) {
    var $module = jQuery('#m-1729539297195').children('.module');
    $module.gfV3ProductPrice({
        displayCurrency: true
    });
})(window.GemQuery || jQuery);
  ...
  var $module = jQuery('#m-1744017574187').children('.module');
  ...
  function changeVariantFunction(variant){
    ...
    (function( jQuery ){
  var $module = jQuery('#m-1729539297156').children('.module');
  $module.gfV3ProductCartButton({ onItemAdded: function(data) {}});
    ...
    (function( jQuery ){
  // var $module = jQuery('#m-1729539297257').children('.module');
  // You can add custom Javascript code right here.
})( window.GemQuery || jQuery );
  (function( jQuery ){
...
$(".form-desktop").click(function(e){
  ...
  // You can add custom Javascript code right here.
    ...
    (function( jQuery ){
  // var $module = jQuery('#m-1729539297263').children('.module');
  // You can add custom Javascript code right here.
})( window.GemQuery || jQuery );
  (function( jQuery ){
  // var $module = jQuery('#m-1686640113860').children('.module');
...
$(".form-desktop").click(function(e){
  ...
  console.log("after clicking button");
    ...
    (function( jQuery ){
  // var $module = jQuery('#m-1729539297205').children('.module');
  // You can add custom Javascript code right here.
})( window.GemQuery || jQuery );
  (function(jQuery) {
  var $module = jQuery('#m-1729539297232').children('.module');
  ...
  $module.gfV3ProductSwatches({
    ...
    (function( jQuery ){
  // var $module = jQuery('#m-1729539297260').children('.module');
  // You can add custom Javascript code right here.
})( window.GemQuery || jQuery );
  (function( jQuery ){
  // var $module = jQuery('#m-1729539297272').children('.module');
  // You can add custom Javascript code right here.
})( window.GemQuery || jQuery );
    (function( jQuery ){
  // var $module = jQuery('#m-1729539297210').children('.module');
  // You can add custom Javascript code right here.
})( window.GemQuery || jQuery );
    ...
    (function( jQuery ){
  // var $module = jQuery('#m-1729539310567').children('.module');
  // You can add custom Javascript code right here.
})( window.GemQuery || jQuery );
  
    (function(jQuery) {
    var $module = jQuery('#m-1729539310613').children('.module');
    $module.gfV3ProductPrice({
        displayCurrency: true
    });
})(window.GemQuery || jQuery);
  ...
  // var $module = jQuery('#m-1722329659392').children('.module');
  // You can add custom Javascript code right here.
})( window.GemQuery || jQuery );
  ...
  (function( jQuery ){
  // var $module = jQuery('#m-1725543765566').children('.module');
  // You can add custom Javascript code right here.
})( window.GemQuery || jQuery );
    (function( jQuery ){
...
window.onclick = function(event) {
  ...
  (function( jQuery ){
  // var $module = jQuery('#m-1743003680514').children('.module');
  // You can add custom Javascript code right here.
})( window.GemQuery || jQuery );
  ...
  // You can add custom Javascript code right here.
    ...
    (function( jQuery ){
  // var $module = jQuery('#m-1729539297193').children('.module');
  // You can add custom Javascript code right here.
})( window.GemQuery || jQuery );
  ...
  (function( jQuery ){
  // var $module = jQuery('#m-1734353864481').children('.module');
  // You can add custom Javascript code right here.
})( window.GemQuery || jQuery );(function( jQuery ){
  var $module = jQuery('#m-1740052220849').children('.module');
  $module.gfV1Popup();

  var mode = jQuery('.gryffeditor').hasClass('editing') ? 'dev' : 'production';
  if(mode == 'dev') {
    var moduleId = "1740052220849";
    var moduleIdSlug = moduleId.toString().replace(/-/g, '');
    if (moduleIdSlug == "1740052220849") {
      window.getPopup1740052220849 = function() {
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    (function( jQuery ){
  // var $module = jQuery('#m-1740052220987').children('.module');
  // You can add custom Javascript code right here.
})( window.GemQuery || jQuery );
  window.__gfFlowActions = []; window.__gfFlowActions.push([{"source":{"id":"#m-1729539297257"},"events":[{"key":"click"}],"targets":[{"id":"#m-1729539297221","actions":[{"key":"scrollToId","type":2,"data":{"delay":0,"duration":150,"marginTop":30}}],"rename":"Accordion: #m-1729539297221"}]}]);window.__gfFlowActions.push([{"source":{"id":"#m-1740052219914"},"events":[{"key":"click"}],"targets":[{"id":"#m-1740052220849","actions":[{"key":"showPopup","type":3,"data":{"delay":0}}],"rename":"Popup: #m-1740052220849"}]}]);window.__gfFlowActions.push([{"source":{"id":"#m-1729539297263"},"events":[{"key":"click"}],"targets":[{"id":"#m-1729539297221","actions":[{"key":"scrollToId","type":2,"data":{"delay":0,"duration":150,"marginTop":30}}],"rename":"Accordion: #m-1729539297221"}]}]);window.__gfFlowActions.push([{"source":{"id":"#m-1740052218218"},"events":[{"key":"click"}],"targets":[{"id":"#m-1740052220849","actions":[{"key":"showPopup","type":3,"data":{"delay":0}}],"rename":"Popup: #m-1740052220849"}]}]);window.__gfFlowActions.push([{"source":{"id":"#e-1705506039380","target":".gf_button"},"events":[{"key":"click"}],"targets":[{"id":"#e-1682498763347","actions":[{"key":"slideUp","type":2,"data":{"delay":0,"duration":300}}],"rename":"Text Block: #e-1682498763347"}]}]);window.__gfFlowActions.push([{"source":{"id":"#e-1706612639056","target":".gf_button"},"events":[{"key":"click"}],"targets":[{"id":"#e-1682498763347","actions":[{"key":"slideUp","type":2,"data":{"delay":0,"duration":300}}],"rename":"Text Block: #e-1682498763347"}]}]);window.__gfFlowActions.push([{"source":{"id":"#e-1705506039468","target":".gf_button"},"events":[{"key":"click"}],"targets":[{"id":"#e-1682498763347","actions":[{"key":"slideUp","type":2,"data":{"delay":0,"duration":300}}],"rename":"Text Block: #e-1682498763347"}]}]); window.__gfV1FlowActions.init();