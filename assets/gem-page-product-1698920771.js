    ...
    (function( jQuery ){
  var $module = jQuery('#m-1729536162474').children('.module');
  $module.gfV3Product();
    ...
    (function( jQuery ){
  // var $module = jQuery('#m-1729536162489').children('.module');
  // You can add custom Javascript code right here.
})( window.GemQuery || jQuery );
  
    (function(jQuery) {
    var $module = jQuery('#m-1729536162423').children('.module');
    ...
    (function( jQuery ){
  // var $module = jQuery('#m-1729536162396').children('.module');
  // You can add custom Javascript code right here.
})( window.GemQuery || jQuery );
  
    (function(jQuery) {
    var $module = jQuery('#m-1729536162393').children('.module');
    $module.gfV3ProductPrice({
        displayCurrency: true
    });
})(window.GemQuery || jQuery);
  ...
  var $module = jQuery('#m-1744021779417').children('.module');
  ...
  function changeVariantFunction(variant){
    ...
    (function( jQuery ){
  var $module = jQuery('#m-1729536162435').children('.module');
  $module.gfV3ProductCartButton({ onItemAdded: function(data) {}});
    ...
    (function( jQuery ){
  // var $module = jQuery('#m-1729536162448').children('.module');
  // You can add custom Javascript code right here.
})( window.GemQuery || jQuery );
  (function( jQuery ){
...
$(".form-desktop").click(function(e){
  ...
  // You can add custom Javascript code right here.
    ...
    (function( jQuery ){
  // var $module = jQuery('#m-1729536162380').children('.module');
  // You can add custom Javascript code right here.
})( window.GemQuery || jQuery );
  (function( jQuery ){
  // var $module = jQuery('#m-1686640113860').children('.module');
...
$(".form-desktop").click(function(e){
  ...
  console.log("after clicking button");
    ...
    (function( jQuery ){
  // var $module = jQuery('#m-1729536162422').children('.module');
  // You can add custom Javascript code right here.
})( window.GemQuery || jQuery );
  (function(jQuery) {
  var $module = jQuery('#m-1729536162403').children('.module');
  ...
  $module.gfV3ProductSwatches({
    ...
    (function( jQuery ){
  // var $module = jQuery('#m-1729536162392').children('.module');
  // You can add custom Javascript code right here.
})( window.GemQuery || jQuery );
  (function( jQuery ){
  // var $module = jQuery('#m-1729536162355').children('.module');
  // You can add custom Javascript code right here.
})( window.GemQuery || jQuery );
    (function( jQuery ){
  // var $module = jQuery('#m-1729536162415').children('.module');
  // You can add custom Javascript code right here.
})( window.GemQuery || jQuery );
  ...
  (function( jQuery ){
  // var $module = jQuery('#m-1729536257579').children('.module');
  // You can add custom Javascript code right here.
})( window.GemQuery || jQuery );
    (function(jQuery) {
    var $module = jQuery('#m-1729536257587').children('.module');
    $module.gfV3ProductPrice({
        displayCurrency: true
    });
})(window.GemQuery || jQuery);
  ...
  // You can add custom Javascript code right here.
    ...
    (function( jQuery ){
  // var $module = jQuery('#m-1719233611340').children('.module');
  // You can add custom Javascript code right here.
})( window.GemQuery || jQuery );
  
    (function( jQuery ){
  // var $module = jQuery('#m-1719233625463').children('.module');
  // You can add custom Javascript code right here.
})( window.GemQuery || jQuery );
  ...
  (function( jQuery ){
  // var $module = jQuery('#m-1743003432156').children('.module');
  // You can add custom Javascript code right here.
})( window.GemQuery || jQuery );
  ...
  try {
    ...
    (function( jQuery ){
  // var $module = jQuery('#m-1729536162472').children('.module');
  // You can add custom Javascript code right here.
})( window.GemQuery || jQuery );
  ...
  (function( jQuery ){
  // var $module = jQuery('#m-1734354335169').children('.module');
  // You can add custom Javascript code right here.
})( window.GemQuery || jQuery );(function( jQuery ){
  var $module = jQuery('#m-1740050856699').children('.module');
  $module.gfV1Popup();

  var mode = jQuery('.gryffeditor').hasClass('editing') ? 'dev' : 'production';
  if(mode == 'dev') {
    var moduleId = "1740050856699";
    var moduleIdSlug = moduleId.toString().replace(/-/g, '');
    if (moduleIdSlug == "1740050856699") {
      window.getPopup1740050856699 = function() {
