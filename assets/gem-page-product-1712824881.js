    ...
    (function( jQuery ){
  var $module = jQuery('#m-1729539820844').children('.module');
  $module.gfV3Product();
    ...
    (function( jQuery ){
  // var $module = jQuery('#m-1729539820838').children('.module');
  // You can add custom Javascript code right here.
})( window.GemQuery || jQuery );
  
    (function(jQuery) {
    var $module = jQuery('#m-1729539820823').children('.module');
    ...
    (function( jQuery ){
  // var $module = jQuery('#m-1729539843858').children('.module');
  // You can add custom Javascript code right here.
})( window.GemQuery || jQuery );
  
    (function(jQuery) {
    var $module = jQuery('#m-1729539843794').children('.module');
    $module.gfV3ProductPrice({
        displayCurrency: true
    });
})(window.GemQuery || jQuery);
  ...
  var $module = jQuery('#m-1744021633374').children('.module');
  ...
  function changeVariantFunction(variant){
    ...
    (function( jQuery ){
  var $module = jQuery('#m-1729539820868').children('.module');
  $module.gfV3ProductCartButton({ onItemAdded: function(data) {}});
    ...
    (function( jQuery ){
  // var $module = jQuery('#m-1729539820829').children('.module');
  // You can add custom Javascript code right here.
})( window.GemQuery || jQuery );
  (function( jQuery ){
...
$(".form-desktop").click(function(e){
  ...
  // You can add custom Javascript code right here.
    ...
    (function( jQuery ){
  // var $module = jQuery('#m-1729539820919').children('.module');
  // You can add custom Javascript code right here.
})( window.GemQuery || jQuery );
  (function( jQuery ){
  // var $module = jQuery('#m-1686640113860').children('.module');
...
$(".form-desktop").click(function(e){
  ...
  console.log("after clicking button");
    ...
    (function( jQuery ){
  // var $module = jQuery('#m-1729539820842').children('.module');
  // You can add custom Javascript code right here.
})( window.GemQuery || jQuery );
  (function(jQuery) {
  var $module = jQuery('#m-1729539820848').children('.module');
  ...
  $module.gfV3ProductSwatches({
    ...
    (function( jQuery ){
  // var $module = jQuery('#m-1729539820790').children('.module');
  // You can add custom Javascript code right here.
})( window.GemQuery || jQuery );
  (function( jQuery ){
  // var $module = jQuery('#m-1729539820854').children('.module');
  // You can add custom Javascript code right here.
})( window.GemQuery || jQuery );
    (function( jQuery ){
  // var $module = jQuery('#m-1729539820815').children('.module');
  // You can add custom Javascript code right here.
})( window.GemQuery || jQuery );
    ...
    (function( jQuery ){
  // var $module = jQuery('#m-1725622236423').children('.module');
  // You can add custom Javascript code right here.
})( window.GemQuery || jQuery );
    ...
    (function( jQuery ){
  // var $module = jQuery('#m-1729539820777').children('.module');
  // You can add custom Javascript code right here.
})( window.GemQuery || jQuery );
  
    (function(jQuery) {
    var $module = jQuery('#m-1729539820837').children('.module');
    $module.gfV3ProductPrice({
        displayCurrency: true
    });
})(window.GemQuery || jQuery);
  ...
  // You can add custom Javascript code right here.
    ...
    (function( jQuery ){
  // var $module = jQuery('#m-1719233468690').children('.module');
  // You can add custom Javascript code right here.
})( window.GemQuery || jQuery );
  
    (function( jQuery ){
  // var $module = jQuery('#m-1719233477747').children('.module');
  // You can add custom Javascript code right here.
})( window.GemQuery || jQuery );
  ...
  (function( jQuery ){
  // var $module = jQuery('#m-1743003974535').children('.module');
  // You can add custom Javascript code right here.
})( window.GemQuery || jQuery );
  ...
  // You can add custom Javascript code right here.
    ...
    (function( jQuery ){
  // var $module = jQuery('#m-1729539820834').children('.module');
  // You can add custom Javascript code right here.
})( window.GemQuery || jQuery );
  ...
  (function( jQuery ){
  // var $module = jQuery('#m-1734354360988').children('.module');
  // You can add custom Javascript code right here.
})( window.GemQuery || jQuery );(function( jQuery ){
  var $module = jQuery('#m-1740051446127').children('.module');
  $module.gfV1Popup();

  var mode = jQuery('.gryffeditor').hasClass('editing') ? 'dev' : 'production';
  if(mode == 'dev') {
    var moduleId = "1740051446127";
    var moduleIdSlug = moduleId.toString().replace(/-/g, '');
    if (moduleIdSlug == "1740051446127") {
      window.getPopup1740051446127 = function() {
