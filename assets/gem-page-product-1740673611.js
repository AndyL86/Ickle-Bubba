  ...
  var $module = jQuery('#m-1744020867514').children('.module');
...
$(".form-desktop").click(function(e){
  ...
  (function( jQuery ){
  // var $module = jQuery('#m-1743001966006').children('.module');
  // You can add custom Javascript code right here.
})( window.GemQuery || jQuery );
  ...
  try {
    ...
    (function( jQuery ){
  // var $module = jQuery('#m-1740673657495').children('.module');
  // You can add custom Javascript code right here.
})( window.GemQuery || jQuery );
  
    (function(jQuery) {
    var $module = jQuery('#m-1740673657451').children('.module');
    $module.gfV3ProductPrice({
        displayCurrency: true
    });
})(window.GemQuery || jQuery);
    ...
    (function( jQuery ){
  // var $module = jQuery('#m-1740673627526').children('.module');
  // You can add custom Javascript code right here.
})( window.GemQuery || jQuery );
  
    (function( jQuery ){
  // var $module = jQuery('#m-1740673627563').children('.module');
  // You can add custom Javascript code right here.
})( window.GemQuery || jQuery );
  ...
  (function(jQuery) {
    ...
    (function( jQuery ){
  // var $module = jQuery('#m-1740673627519').children('.module');
  // You can add custom Javascript code right here.
})( window.GemQuery || jQuery );
  (function( jQuery ){
  try {
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  window.__gfFlowActions = []; window.__gfFlowActions.push([{"source":{"id":"#m-1729540528626"},"events":[{"key":"click"}],"targets":[{"id":"#e-1740063964655","actions":[{"key":"scrollToId","type":2,"data":{"delay":0,"duration":150,"marginTop":30}}],"rename":"Text Block: #e-1740063964655"}]}]);window.__gfFlowActions.push([{"source":{"id":"#m-1740049724265"},"events":[{"key":"click"}],"targets":[{"id":"#m-1740049725866","actions":[{"key":"showPopup","type":3,"data":{"delay":0}}],"rename":"Popup: #m-1740049725866"}]}]);window.__gfFlowActions.push([{"source":{"id":"#m-1729540528609"},"events":[{"key":"click"}],"targets":[{"id":"#e-1740063964655","actions":[{"key":"scrollToId","type":2,"data":{"delay":0,"duration":150,"marginTop":30}}],"rename":"Text Block: #e-1740063964655"}]}]);window.__gfFlowActions.push([{"source":{"id":"#m-1740049721564"},"events":[{"key":"click"}],"targets":[{"id":"#m-1740049725866","actions":[{"key":"showPopup","type":3,"data":{"delay":0}}],"rename":"Popup: #m-1740049725866"}]}]);window.__gfFlowActions.push([{"source":{"id":"#m-1740673627563"},"events":[{"key":"click"}],"targets":[{"id":"#m-1740673627519","actions":[{"key":"scrollToId","type":2,"data":{"delay":0,"duration":500,"marginTop":30}}],"rename":"Liquid: #m-1740673627519"}],"disableOn":["md","xs"]}]);window.__gfFlowActions.push([{"source":{"id":"#e-1740673627580","target":".gf_button"},"events":[{"key":"click"}],"targets":[{"id":"#e-1682498763347","actions":[{"key":"slideUp","type":2,"data":{"delay":0,"duration":300}}],"rename":"Text Block: #e-1682498763347"}]}]); window.__gfV1FlowActions.init();