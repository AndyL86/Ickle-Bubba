...
$(".form-desktop").click(function(e){
  ...
  (function( jQuery ){
  var $module = jQuery('#m-1744624963026').children('.module');
  ...
  if(mode == 'dev') {
    var moduleId = "1744624963026";
    var moduleIdSlug = moduleId.toString().replace(/-/g, '');
    if (moduleIdSlug == "1744624963026") {
      window.getTab1744624963026 = function() {
    ...
    (function( jQuery ){
  var $module = jQuery('#m-1744624963094').children('.module');
  $module.gfV3ProductDesc();
})( window.GemQuery || jQuery );
  
    (function( jQuery ){
  // var $module = jQuery('#m-1744624963015').children('.module');
  // You can add custom Javascript code right here.
})( window.GemQuery || jQuery );
  
    (function( jQuery ){
  // var $module = jQuery('#m-1744624963108').children('.module');
  // You can add custom Javascript code right here.
})( window.GemQuery || jQuery );
    ...
    (function( jQuery ){
  var $module = jQuery('#m-1744624962981').children('.module');
  var activeTab = parseInt($module.attr('data-activeTab')) - 1;
  var mode = jQuery('.gryffeditor').hasClass('editing') ? 'dev' : 'production';
  ...
  if(mode == 'dev') {
    var moduleId = "1744624962981";
    var moduleIdSlug = moduleId.toString().replace(/-/g, '');
    if (moduleIdSlug == "1744624962981") {
      window.getTab1744624962981 = function() {
        return $module.data('gfv3restabs');
      }
    }
  }
    ...
    (function( jQuery ){
  // var $module = jQuery('#m-1744624963029').children('.module');
  // You can add custom Javascript code right here.
})( window.GemQuery || jQuery );
  
    (function( jQuery ){
  // var $module = jQuery('#m-1744624962938').children('.module');
  // You can add custom Javascript code right here.
})( window.GemQuery || jQuery );
  (function( jQuery ){
  // var $module = jQuery('#m-1744624962957').children('.module');
  // You can add custom Javascript code right here.
})( window.GemQuery || jQuery );
  ...
  (function( jQuery ){
  // var $module = jQuery('#m-1744624963067').children('.module');
  // You can add custom Javascript code right here.
})( window.GemQuery || jQuery );(function( jQuery ){
  ...
  (function( jQuery ){
  try {
    var $module = jQuery('#m-1744624963056').children('.module');   
    ...
    (function( jQuery ){
  // var $module = jQuery('#m-1744624963101').children('.module');
  // You can add custom Javascript code right here.
})( window.GemQuery || jQuery );
  
    (function( jQuery ){
  // var $module = jQuery('#m-1744624962963').children('.module');
  // You can add custom Javascript code right here.
})( window.GemQuery || jQuery );
  
    (function( jQuery ){
  // var $module = jQuery('#m-1744624963051').children('.module');
  // You can add custom Javascript code right here.
})( window.GemQuery || jQuery );
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  window.__gfFlowActions = []; window.__gfFlowActions.push([{"source":{"id":"#m-1729540329525"},"events":[{"key":"click"}],"targets":[{"id":"#m-1729540329524","actions":[{"key":"scrollToId","type":2,"data":{"delay":0,"duration":150,"marginTop":30}}],"rename":"Accordion: #m-1729540329524"}]}]);window.__gfFlowActions.push([{"source":{"id":"#m-1740049466019"},"events":[{"key":"click"}],"targets":[{"id":"#m-1740049469540","actions":[{"key":"showPopup","type":3,"data":{"delay":0}}],"rename":"Popup: #m-1740049469540"}]}]);window.__gfFlowActions.push([{"source":{"id":"#e-1744624962977","target":".gf_button"},"events":[{"key":"click"}],"targets":[{"id":"#e-1682498763347","actions":[{"key":"slideUp","type":2,"data":{"delay":0,"duration":300}}],"rename":"Text Block: #e-1682498763347"}]}]);window.__gfFlowActions.push([{"source":{"id":"#e-1744624963027","target":".gf_button"},"events":[{"key":"click"}],"targets":[{"id":"#e-1682498763347","actions":[{"key":"slideUp","type":2,"data":{"delay":0,"duration":300}}],"rename":"Text Block: #e-1682498763347"}]}]); window.__gfV1FlowActions.init();