    ...
    (function( jQuery ){
  try {
    var $module = jQuery('#m-1716300747633').children('.module');   
  ...
  $module.gfV2HeroBanner({});
    ...
    (function( jQuery ){
  var $module = jQuery('#m-1716474832790').children('.module');
  $module.gfV2HeroBanner({});
  
})( window.GemQuery || jQuery );
  
    (function( jQuery ){
  var $module = jQuery('#m-1716475517381').children('.module');
  $module.gfV2HeroBanner({});
    ...
    (function( jQuery ){
  try {
    var $module = jQuery('#m-1716301362958').children('.module');   
    var navspeed = $module.data('navspeed'),
      autoplaytimeout = $module.data('autoplaytimeout'),
      autoplayhoverpause = $module.data('autoplayhoverpause'),
      navlg = $module.data('navlg'),
    ...
    (function( jQuery ){
  var $module = jQuery('#m-1716301362939').children('.module');
  $module.gfV2HeroBanner({});
    ...
    (function( jQuery ){
  var $module = jQuery('#m-1716302143982').children('.module');
  $module.gfV2HeroBanner({});
    ...
    (function( jQuery ){
  var $module = jQuery('#m-1716366323235').children('.module');
  $module.gfV2HeroBanner({});
    ...
    (function( jQuery ){
  var $module = jQuery('#m-1716475809713').children('.module');
  $module.gfV2HeroBanner({});
  ...
  $module.gfV3ProductImage({
    ...
    (function( jQuery ){
  var $module = jQuery('#m-1716890894900').children('.module');
  $module.gfV3Product();
})( window.GemQuery || jQuery );
  
    (function(jQuery) {
  var $module = jQuery('#m-1716890894900-0').children('.module');
  var effect = $module.attr('data-effect');
  var magnify = $module.attr('data-zoom-level');
  var displayType = $module.attr('data-displaytype');
  $module.gfV3ProductImage({
    ...
    (function(jQuery) {
    var $module = jQuery('#m-1716890894900-2').children('.module');
    $module.gfV3ProductPrice({
        displayCurrency: true
    });
})(window.GemQuery || jQuery);
...
$(".pop-up-comp").click(function(e){
  ...
  console.log("after clicking button");
    ...
    (function( jQuery ){
  var $module = jQuery('#m-1716301207109').children('.module');
  $module.gfV2HeroBanner({});
  
})( window.GemQuery || jQuery );
  
    (function( jQuery ){
  var $module = jQuery('#m-1716301287022').children('.module');
  $module.gfV2HeroBanner({});
