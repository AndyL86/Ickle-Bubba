  ...
  var $module = jQuery('#m-1744020828266').children('.module');
...
$(".form-desktop").click(function(e){
  ...
  (function( jQuery ){
  var $module = jQuery('#m-1743519916109').children('.module');
  ...
  if(mode == 'dev') {
    var moduleId = "1743519916109";
    var moduleIdSlug = moduleId.toString().replace(/-/g, '');
    if (moduleIdSlug == "1743519916109") {
      window.getTab1743519916109 = function() {
    ...
    (function( jQuery ){
  var $module = jQuery('#m-1743519916046').children('.module');
  $module.gfV3ProductDesc();
})( window.GemQuery || jQuery );
  
    (function( jQuery ){
  // var $module = jQuery('#m-1743519916119').children('.module');
  // You can add custom Javascript code right here.
})( window.GemQuery || jQuery );
  
    (function( jQuery ){
  // var $module = jQuery('#m-1743519916209').children('.module');
  // You can add custom Javascript code right here.
})( window.GemQuery || jQuery );
  ...
  (function( jQuery ){
  try {
    var $module = jQuery('#m-1740673627522').children('.module');   
  ...
  (function( jQuery ){
  try {
    var $module = jQuery('#m-1740673627538').children('.module');   
    var navspeed = $module.data('navspeed'),
      autoplaytimeout = $module.data('autoplaytimeout'),
      autoplayhoverpause = $module.data('autoplayhoverpause'),
      navlg = $module.data('navlg'),
    ...
    var $module = jQuery('#m-1740673627568').children('.module');
  ...
  (function(jQuery) {
    var $module = jQuery('#m-1740673627553').children('.module');
    $module.find('.video-popup')?.magnificPopup?.({
        type: 'iframe',
        iframe: {
            patterns: {
  ...
  (function(jQuery) {
    var $module = jQuery('#m-1740673627600').children('.module');
    $module.find('.video-popup')?.magnificPopup?.({
        type: 'iframe',
        iframe: {
            patterns: {
    ...
    (function( jQuery ){
  var $module = jQuery('#m-1743519956463').children('.module');
  var activeTab = parseInt($module.attr('data-activeTab')) - 1;
  var mode = jQuery('.gryffeditor').hasClass('editing') ? 'dev' : 'production';
  ...
  if(mode == 'dev') {
    var moduleId = "1743519956463";
    var moduleIdSlug = moduleId.toString().replace(/-/g, '');
    if (moduleIdSlug == "1743519956463") {
      window.getTab1743519956463 = function() {
        return $module.data('gfv3restabs');
      }
    }
  }
    ...
    (function( jQuery ){
  // var $module = jQuery('#m-1743519956525').children('.module');
  // You can add custom Javascript code right here.
})( window.GemQuery || jQuery );
  ...
  (function( jQuery ){
  // var $module = jQuery('#m-1743519956514').children('.module');
  // You can add custom Javascript code right here.
})( window.GemQuery || jQuery );
    
  (function( jQuery ){
  try {
    var $module = jQuery('#m-1740673627546').children('.module');   
    var navspeed = $module.data('navspeed'),
      autoplaytimeout = $module.data('autoplaytimeout'),
      autoplayhoverpause = $module.data('autoplayhoverpause'),
      navlg = $module.data('navlg'),
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  window.__gfFlowActions = []; window.__gfFlowActions.push([{"source":{"id":"#m-1729540528626"},"events":[{"key":"click"}],"targets":[{"id":"#e-1740063964655","actions":[{"key":"scrollToId","type":2,"data":{"delay":0,"duration":150,"marginTop":30}}],"rename":"Text Block: #e-1740063964655"}]}]);window.__gfFlowActions.push([{"source":{"id":"#m-1740049724265"},"events":[{"key":"click"}],"targets":[{"id":"#m-1740049725866","actions":[{"key":"showPopup","type":3,"data":{"delay":0}}],"rename":"Popup: #m-1740049725866"}]}]);window.__gfFlowActions.push([{"source":{"id":"#m-1729540528609"},"events":[{"key":"click"}],"targets":[{"id":"#e-1740063964655","actions":[{"key":"scrollToId","type":2,"data":{"delay":0,"duration":150,"marginTop":30}}],"rename":"Text Block: #e-1740063964655"}]}]);window.__gfFlowActions.push([{"source":{"id":"#m-1740049721564"},"events":[{"key":"click"}],"targets":[{"id":"#m-1740049725866","actions":[{"key":"showPopup","type":3,"data":{"delay":0}}],"rename":"Popup: #m-1740049725866"}]}]);window.__gfFlowActions.push([{"source":{"id":"#e-1743519916127","target":".gf_button"},"events":[{"key":"click"}],"targets":[{"id":"#e-1682498763347","actions":[{"key":"slideUp","type":2,"data":{"delay":0,"duration":300}}],"rename":"Text Block: #e-1682498763347"}]}]);window.__gfFlowActions.push([{"source":{"id":"#e-1743519956464","target":".gf_button"},"events":[{"key":"click"}],"targets":[{"id":"#e-1682498763347","actions":[{"key":"slideUp","type":2,"data":{"delay":0,"duration":300}}],"rename":"Text Block: #e-1682498763347"}]}]); window.__gfV1FlowActions.init();