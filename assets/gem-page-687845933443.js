  ...
  // Target the SquadKin form container
  const $squadkinForm = $('.sk-form');

  // Find the form submission button within the SquadKin form
  const $squadkinSubmitButton = $squadkinForm.find('button[type="submit"]');

  // Attach the click event handler to the SquadKin form's submit button
  $squadkinSubmitButton.on('click', function(e) {
    exponea.showBanner('64df736ed11e654477c50865');
    console.log("SquadKin form submitted, banner shown");
  });
  ...
  // You can add custom Javascript code right here.
    ...
    (function( jQuery ){
  var $module = jQuery('#m-1733233345172').children('.module');
  $module.gfV1Popup();

  var mode = jQuery('.gryffeditor').hasClass('editing') ? 'dev' : 'production';
  if(mode == 'dev') {
    var moduleId = "1733233345172";
    var moduleIdSlug = moduleId.toString().replace(/-/g, '');
    if (moduleIdSlug == "1733233345172") {
      window.getPopup1733233345172 = function() {
    ...
    (function( jQuery ){
  // var $module = jQuery('#m-1733233562677').children('.module');
  // You can add custom Javascript code right here.
})( window.GemQuery || jQuery );
  
    
  window.__gfFlowActions = []; window.__gfFlowActions.push([{"source":{"id":"#e-1733216053113","target":".elm"},"events":[{"key":"click"}],"targets":[{"id":"#m-1733233345172","actions":[{"key":"showPopup","type":3,"data":{"delay":0}}],"rename":"Popup: #m-1733233345172"}]}]);window.__gfFlowActions.push([{"source":{"id":"#e-1731068625884","target":".gf_button"},"events":[{"key":"click"}],"targets":[{"id":"#e-1731068625955","actions":[{"key":"scrollToId","type":2,"data":{"delay":0,"duration":500,"marginTop":30}}],"rename":"Text Block: #e-1731068625955"}]}]);window.__gfFlowActions.push([{"source":{"id":"#e-1731069391137","target":".gf_button"},"events":[{"key":"click"}],"targets":[{"id":"#r-1731068625862","actions":[{"key":"scrollToId","type":2,"data":{"delay":0,"duration":500,"marginTop":30}}],"rename":"Row: #r-1731068625862"}]}]); window.__gfV1FlowActions.init();