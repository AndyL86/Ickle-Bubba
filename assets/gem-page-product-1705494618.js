  ...
  $module.gfV3Product();
    ...
    (function( jQuery ){
  // var $module = jQuery('#m-1729527141816').children('.module');
  // You can add custom Javascript code right here.
    ...
    (function( jQuery ){
  // var $module = jQuery('#m-1729527036611').children('.module');
  // You can add custom Javascript code right here.
})( window.GemQuery || jQuery );
  ...
  var $module = jQuery('#m-1744021681256').children('.module');
...
$(".form-desktop").click(function(e){
  ...
  // You can add custom Javascript code right here.
    ...
    (function( jQuery ){
  // var $module = jQuery('#m-1709641745049').children('.module');
  // You can add custom Javascript code right here.
})( window.GemQuery || jQuery );
  ...
  (function( jQuery ){
  // var $module = jQuery('#m-1743003957281').children('.module');
  // You can add custom Javascript code right here.
})( window.GemQuery || jQuery );
  ...
  // You can add custom Javascript code right here.
    ...
    (function( jQuery ){
  // var $module = jQuery('#m-1725970732262').children('.module');
  // You can add custom Javascript code right here.
})( window.GemQuery || jQuery );
  ...
  (function( jQuery ){
  // var $module = jQuery('#m-1734354354365').children('.module');
  // You can add custom Javascript code right here.
})( window.GemQuery || jQuery );(function( jQuery ){
  var $module = jQuery('#m-1740051517736').children('.module');
  $module.gfV1Popup();

  var mode = jQuery('.gryffeditor').hasClass('editing') ? 'dev' : 'production';
  if(mode == 'dev') {
    var moduleId = "1740051517736";
    var moduleIdSlug = moduleId.toString().replace(/-/g, '');
    if (moduleIdSlug == "1740051517736") {
      window.getPopup1740051517736 = function() {
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    (function( jQuery ){
  // var $module = jQuery('#m-1740051517794').children('.module');
  // You can add custom Javascript code right here.
})( window.GemQuery || jQuery );
  window.__gfFlowActions = []; window.__gfFlowActions.push([{"source":{"id":"#m-1698937803952"},"events":[{"key":"click"}],"targets":[{"id":"#m-1693914375127","actions":[{"key":"scrollToId","type":2,"data":{"delay":0,"duration":150,"marginTop":30}}],"rename":"Accordion: #m-1693914375127"}]}]);window.__gfFlowActions.push([{"source":{"id":"#m-1740051516334"},"events":[{"key":"click"}],"targets":[{"id":"#m-1740051517736","actions":[{"key":"showPopup","type":3,"data":{"delay":0}}],"rename":"Popup: #m-1740051517736"}]}]);window.__gfFlowActions.push([{"source":{"id":"#m-1698937803963"},"events":[{"key":"click"}],"targets":[{"id":"#m-1693914375127","actions":[{"key":"scrollToId","type":2,"data":{"delay":0,"duration":150,"marginTop":30}}],"rename":"Accordion: #m-1693914375127"}]}]);window.__gfFlowActions.push([{"source":{"id":"#m-1740051513805"},"events":[{"key":"click"}],"targets":[{"id":"#m-1740051517736","actions":[{"key":"showPopup","type":3,"data":{"delay":0}}],"rename":"Popup: #m-1740051517736"}]}]); window.__gfV1FlowActions.init();